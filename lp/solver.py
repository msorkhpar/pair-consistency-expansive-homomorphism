...
class Solver:
    def __init__(self, g: nx.Graph, h: nx.Graph, mapping_costs: dict[EdgeMap, dict[str, float]],transform_labels=None):
        ...
        self.parameters = Parameters(g_edges, h_edges, mapping_costs,transform_labels=None)
